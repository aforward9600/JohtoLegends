MysteryGiftDecos:
	...
	db DECOFLAG_KOTORA_DOLL
	db DECOFLAG_GENGAR_DOLL
	db DECOFLAG_CLEFAIRY_POSTER
	db DECOFLAG_JIGGLYPUFF_POSTER
	db DECOFLAG_SNES
	db DECOFLAG_CYNDAQUIL_DOLL
	db DECOFLAG_LOTAD_DOLL
	db DECOFLAG_CHIKORITA_DOLL
