...
.Frameset_GSIntroBubble:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_BUBBLE_1,  16
	frame SPRITE_ANIM_OAMSET_GS_INTRO_BUBBLE_2,  16
	dorestart

.Frameset_GSIntroShellder:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_SHELLDER_1,  16
	frame SPRITE_ANIM_OAMSET_GS_INTRO_SHELLDER_2,  16
	dorestart

.Frameset_GSIntroMagikarp:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_MAGIKARP_1,  2, OAM_X_FLIP
	frame SPRITE_ANIM_OAMSET_GS_INTRO_MAGIKARP_2,  2, OAM_X_FLIP
	dorestart
...
.Frameset_GSIntroLapras:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_LAPRAS_2,  14
	frame SPRITE_ANIM_OAMSET_GS_INTRO_LAPRAS_3,  14
	frame SPRITE_ANIM_OAMSET_GS_INTRO_LAPRAS_4,  14
	frame SPRITE_ANIM_OAMSET_GS_INTRO_LAPRAS_2,  14
	dorestart
