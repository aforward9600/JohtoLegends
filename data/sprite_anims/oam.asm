...
; entries correspond to SPRITE_ANIM_OAMSET_* constants
	...
	dbw $00, .OAMData_PartyMon                 ; SPRITE_ANIM_OAMSET_PARTY_MON__1
	dbw $04, .OAMData_PartyMon                 ; SPRITE_ANIM_OAMSET_PARTY_MON__2
...
.OAMData_RadioTuningKnob:
	db 3
	dsprite -2,  4, -1,  4, $10, 0 | OBP_NUM
	dsprite -1,  4, -1,  4, $10, 0 | OBP_NUM
	dsprite  0,  4, -1,  4, $10, 0 | OBP_NUM
