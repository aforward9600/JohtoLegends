...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $40, BATTLEANIMFRAMESET_2B, BATTLEANIMFUNC_11, PAL_BATTLE_OB_YELLOW, ANIM_GFX_POWDER ; ANIM_OBJ_POWDER
	...
	battleanimobj RELATIVE_X | X_FLIP, $48, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_BLUE, ANIM_GFX_HAZE ; ANIM_OBJ_MIST
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_06, PAL_BATTLE_OB_GREEN, ANIM_GFX_EGG ; ANIM_OBJ_ENERGY_BALL
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_RAZOR_LEAF, PAL_BATTLE_OB_RED, ANIM_GFX_PLANT ; ANIM_OBJ_MAGICAL_LEAF
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_4D, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ROCKS ; ANIM_OBJ_POWER_GEM
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_06, PAL_BATTLE_OB_BROWN, ANIM_GFX_EGG ; ANIM_OBJ_MUD_BOMB
	battleanimobj RELATIVE_X, $aa, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_10, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_WILL_O_WISP
	battleanimobj RELATIVE_X | X_FLIP, $00, BATTLEANIMFRAMESET_15, BATTLEANIMFUNC_4A, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE ; ANIM_OBJ_HAIL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_06, PAL_BATTLE_OB_BLUE, ANIM_GFX_EGG ; ANIM_OBJ_AURA_SPHERE
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_41, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GREEN, ANIM_GFX_CUT ; ANIM_SOLAR_BLADE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_1C, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE ; ANIM_OBJ_DRAININGKISS
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_01, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BLUE, ANIM_GFX_HIT ; ANIM_OBJ_WATER_HIT
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_3E, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_HONE_CLAWS_R
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_3F, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_HONE_CLAWS_L
	battleanimobj RELATIVE_X | X_FLIP, $70, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_3F, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_STEALTH_ROCK
	...
	battleanimobj RELATIVE_X | X_FLIP, $20, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_4A, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_HEAT_WAVE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON ; ANIM_OBJ_SHELLSIDEARM
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_21, BATTLEANIMFUNC_3D, PAL_BATTLE_OB_BLUE, ANIM_GFX_BUBBLE ; ANIM_OBJ_AQUA_RING
	...
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_36, PAL_BATTLE_OB_GRAY, ANIM_GFX_MOON ; ANIM_OBJ_MOON
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_06, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT ; ANIM_OBJ_BULLET_SEED
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_04, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON ; ANIM_OBJ_SLUDGE_WAVE
	battleanimobj RELATIVE_X | X_FLIP |Y_FLIP, $90, BATTLEANIMFRAMESET_FOCUS_BLAST, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, ANIM_GFX_FOCUS_BLAST ; ANIM_OBJ_FOCUS_BLAST
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_SWIRL, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_SWIRL ; ANIM_OBJ_SWIRL
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLEANIMFRAMESET_VORTEX, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_VORTEX ; ANIM_OBJ_VORTEX
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_06, PAL_BATTLE_OB_YELLOW, ANIM_GFX_AURA_SPHERE ; ANIM_OBJ_AURA_SPHERE
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLEANIMFRAMESET_SWIRL_SHORT, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_SWIRL ; ANIM_OBJ_SHORT_SWIRL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_SMALL_GLOW, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, ANIM_GFX_GLOW ; ANIM_OBJ_SMALL_GLOW
	battleanimobj RELATIVE_X | X_FLIP, $75, BATTLEANIMFRAMESET_98, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_MISC ; ANIM_OBJ_FEATHER_DANCE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_DROPLET_R, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_MISC_2 ; ANIM_OBJ_DROPLET_1
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_DROPLET_L, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_MISC_2 ; ANIM_OBJ_DROPLET_2
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_DROPLET_L, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_MISC_2 ; ANIM_OBJ_TEARS_1
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_DROPLET_R, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_MISC_2 ; ANIM_OBJ_TEARS_2
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_1E, PAL_BATTLE_OB_BLUE, ANIM_GFX_SPEED ; ANIM_OBJ_47
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_1E, PAL_BATTLE_OB_RED, ANIM_GFX_SPEED ; ANIM_OBJ_STAT_UP
	battleanimobj RELATIVE_X, $54, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_STRAIGHT_DESCENT, PAL_BATTLE_OB_BLUE, ANIM_GFX_SPEED ; ANIM_OBJ_STAT_DOWN
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_3C, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_QUIVER_DANCE
