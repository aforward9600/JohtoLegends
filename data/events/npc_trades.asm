...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, ELEKID,     KABUTO,     "Kabby@@@@@@", $96, $77, MIRAGE_MAIL,  49635, "Rocky@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, SMOOCHUM,   OMANYTE,    "Lord Helix@", $96, $77, EON_MAIL,     42069, "Sheldon@", TRADE_GENDER_FEMALE
