...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_NEWBIE,    TANGELA,    RAPIDASH,   "Epona@@@@@@", $b9, $e9, RAWST_BERRY,  48926, "Damien@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, DUSKULL,    BRONZOR,    "Reflecto@@@", $96, $86, LEPPA_BERRY,  15616, "Tim@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      MAGBY,      SQUIRTLE,   "Tortie@@@@@", $98, $88, ASPEAR_BERRY, 00283, "Jenny@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      HERACROSS,  BLISSEY,    "Blessed@@@@", $98, $88, PECHA_BERRY,  29189, "Sarah@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      BAGON,      DRATINI,    "Drasna@@@@@", $b9, $e9, SITRUS_BERRY, 26491, "Jewel@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_GIRL,      GIBLE,      LARVITAR,   "Terra@@@@@@", $b9, $e9, SITRUS_BERRY, 26491, "Jewel@@@", TRADE_GENDER_EITHER
