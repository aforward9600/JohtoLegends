...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, PHANPY,     PIKACHU,    "Pooka@@@@@@", $96, $66, METAL_COAT,   50082, "Forest@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, ELEKID,     KABUTO,     "Kabby@@@@@@", $96, $77, LEPPA_BERRY,  49635, "Rocky@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, SMOOCHUM,   OMANYTE,    "Lord Helix@", $96, $77, LUM_BERRY,    42069, "Sheldon@", TRADE_GENDER_FEMALE
