...
ArcherGroup:
	...
	db 37
	dw NIDOKING
	dw POISON_JAB, BULLDOZE, THRASH, LEER
	db -1 ; end
	...
	db 45
	dw WEEZING
	dw MUD_BOMB, SLUDGE_BOMB, SELFDESTRUCT, HAZE
	db 45
	dw HOUNDOOM
	dw ODOR_SLEUTH, FAINT_ATTACK, SNARL, FLAMETHROWER
	db 45
	dw MACHAMP
	dw BULK_UP, BRICK_BREAK, VITAL_THROW, KNOCK_OFF
	db 46
	...
	db 53
	dw HOUNDOOM
	dw WILL_O_WISP, CRUNCH, DARK_PULSE, FLAMETHROWER
	db 53
	dw MACHAMP
	dw BULK_UP, BRICK_BREAK, VITAL_THROW, KNOCK_OFF
	db 54
	dw NIDOKING
	dw POISON_JAB, EARTHQUAKE, STOMP, MEGAHORN
	db 55
	dw ENTEI
	dw FIRE_FANG, SWAGGER, EARTHQUAKE, STOMP
	db -1 ; end
...
ArianaGroup:
	...
	db 36
	dw NIDOQUEEN
	dw BODY_SLAM, POISON_JAB, BULLDOZE, TAIL_WHIP
	db -1 ; end
	...
	db 50
	dw HONCHKROW
	dw DRILL_PECK, FAINT_ATTACK, ROOST, NIGHT_SHADE
	db 51
	dw ALAKAZAM
	dw PSYCHIC_M, ENERGY_BALL, DAZZLINGLEAM, CALM_MIND
	db 51
	...
	db 52
	dw SUICUNE
	dw SURF, ICE_BEAM, MIRROR_COAT, RAIN_DANCE
	db -1 ; end
...
DepressedDahliaGroup:
	...
	db 41
	dw DRAGONITE
	dw DRAGON_TAIL, HURRICANE, SLAM, THUNDER_WAVE
	db -1 ; end
