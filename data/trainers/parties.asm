...
EnokiGroup:
	...
	db 25
	dw HAUNTER
	dw HEX, PAYBACK, CONFUSE_RAY, SHADOW_PUNCH
	db 25
	dw CORSOLA
	...
	db 28
	dw HAUNTER
	dw HEX, FAINT_ATTACK, CONFUSE_RAY, SHADOW_PUNCH
	db 28
	dw CORSOLA
	...
	db 39
	dw NINETALES
	dw FLAMETHROWER, EXTRASENSORY, WILL_O_WISP, HEX
	db 40
	dw MISMAGIUS
	dw HEX, WILL_O_WISP, PAIN_SPLIT, MAGICAL_LEAF
	db -1 ; end
...
PryceGroup:
	...
	db 25
	dw LAPRAS
	dw RAIN_DANCE, BODY_SLAM, WATER_PULSE, ICY_WIND
	db 26
	dw SNEASEL
	...
	db 28
	dw LAPRAS
	dw PERISH_SONG, BODY_SLAM, WATER_PULSE, ICY_WIND
	db 29
	dw SNEASEL
...
ChigusaGroup:
	...
	db 35
	dw PRIMEAPE
	dw BULK_UP, CROSS_CHOP, ROCK_SLIDE, PAYBACK
	db 36
	dw MACHOKE
	dw BULK_UP, VITAL_THROW, ROCK_SLIDE, FAINT_ATTACK
	db 36
	dw HITMONLEE
