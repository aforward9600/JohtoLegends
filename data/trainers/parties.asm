...
endc
	...
	db 55
	dw XATU
	dw ROOST, PSYCHIC_M, AIR_SLASH, SHADOW_BALL
	db 55
	dw DUDUNSPARS
if DEF(_FAITHFUL)
...
endc
	...
	dw MR__RIME
	db NO_ITEM
	dw ICE_BEAM, CALM_MIND, PSYCHIC_M, HAIL
	db 57
	dw TANGROWTH
	db NO_ITEM
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw CRUNCH, DOUBLE_EDGE, SUCKER_PUNCH, FIRE_FANG
	db 55
	dw CACTURNE
if DEF(_CHALLENGE)
	db MIRACLE_SEED
...
endc
	...
	db 57
	dw WEEZING_G
	dw BELCH, DESTINY_BOND, MOONBLAST, FIRE_BLAST
	db 56
	dw GARDEVOIR
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw AQUA_JET, BITE, ICE_FANG, SWAGGER
	db 0 ; ROUGH_SKIN
	db -1 ; end
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw WATERFALL, CRUNCH, ICE_FANG, POISON_FANG
	db 0 ; ROUGH_SKIN
	db 38
	dw HONCHKROW
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw WATERFALL, ICE_FANG, POISON_FANG, CRUNCH
	db 0 ; ROUGH_SKIN
	db 46
	dw HONCHKROW
if DEF(_CHALLENGE)
