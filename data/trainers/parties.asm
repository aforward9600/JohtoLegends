...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw X_SCISSOR, AERIAL_ACE, SWORDS_DANCE, SUPERPOWER
	db 2 ; MOXIE
	db 53
if DEF(_CHALLENGE)
	dw GLISCOR
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw U_TURN, DIRE_CLAW, CLOSE_COMBAT, ACROBATICS
	db 1 ; UNBURDEN
	db 75
	dw TENTACRUEL
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw PINCIRFLURRY, CLOSE_COMBAT, STONE_EDGE, EARTHQUAKE
	db 61
	dw DONPHAN
if DEF(_CHALLENGE)
	db LEFTOVERS
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw CLOSE_COMBAT, IRON_HEAD, BULK_UP, FAKE_OUT
	db 2 ; JUSTIFIED
	db 57
	dw GARCHOMP
if DEF(_CHALLENGE)
...
endc
	...
	dw MEDICHAM
	db BLACKBELT
	dw ZEN_HEADBUTT, RECOVER, CLOSE_COMBAT, IRON_HEAD
	db 0 ; PURE_POWER
	db 54
	dw SIRFETCH_D
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw ROOST, CLOSE_COMBAT, BRAVE_BIRD, KNOCK_OFF
	db 2 ; SCRAPPY
	db 67
	dw HITMONTOP
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw CLOSE_COMBAT, IRON_HEAD, BULK_UP, EXTREMESPEED
	db 2 ; JUSTIFIED
	db 68
	dw GARCHOMP
if DEF(_CHALLENGE)
...
endc
	...
	db 76
	dw TYRANITAR
	dw CLOSE_COMBAT, EARTHQUAKE, CRUNCH, STONE_EDGE
	db 77
	dw CHARIZARD
