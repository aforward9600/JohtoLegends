...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw THUNDER_FANG, STONE_EDGE, HEAT_WAVE, EXTREMESPEED
	db 0 ; INTIMIDATE
	db 45
	dw ROSERADE
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw THUNDER_FANG, STONE_EDGE, FLARE_BLITZ, EXTREMESPEED
	db 0 ; INTIMIDATE
	db 53
	dw ROSERADE
if DEF(_CHALLENGE)
...
if DEF(_CHALLENGE)
	...
	dw ANNIHILAPE
	db CHOICE_BAND
	dw CLOSE_COMBAT, ICE_PUNCH, SHADOW_PUNCH, ROCK_SLIDE
	db 2 ; DEFIANT
else
	db 43
	dw TOXICROAK
...
if DEF(_CHALLENGE)
	db CHOICE_BAND
	dw ICE_PUNCH, CLOSE_COMBAT, SHADOW_PUNCH, HIHORSEPOWER
else
	db NO_ITEM
	dw BULK_UP, CLOSE_COMBAT, SHADOW_PUNCH, HIHORSEPOWER
endc
	db 2 ; DEFIANT
	db 50
	dw SIRFETCH_D
...
if DEF(_CHALLENGE)
	db CHOICE_BAND
	dw CLOSE_COMBAT, ROCK_SLIDE, ICE_PUNCH, SHADOW_PUNCH
else
	db NO_ITEM
	dw BULK_UP, CLOSE_COMBAT, ROCK_SLIDE, SHADOW_PUNCH
endc
	db 2 ; DEFIANT
	db 54
	dw SIRFETCH_D
...
if DEF(_CHALLENGE)
	db CHOICE_BAND
	dw PHANTOMFORCE, CLOSE_COMBAT, EARTHQUAKE, ROCK_SLIDE
else
	db NO_ITEM
	dw BULK_UP, PHANTOMFORCE, CLOSE_COMBAT, ROCK_SLIDE
endc
	db 2 ; DEFIANT
	db 67
	dw SIRFETCH_D
...
if DEF(_CHALLENGE)
	...
	db NO_ITEM
endc
	dw THUNDER_FANG, STONE_EDGE, RAGING_FURY, EXTREMESPEED
	db 0 ; INTIMIDATE
	db 67
	dw ROSERADE
if DEF(_CHALLENGE)
