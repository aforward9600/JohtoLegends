...
; GOOD_ROD
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; LIECHI_BERRY
	item_attribute 9000, HELD_ATTACK_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SUPER_ROD
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; PP_UP
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; WIDE_LENS
	item_attribute 2000, HELD_ACCURACY_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE_SPECS
	item_attribute 2000, HELD_CHOICE_BOOST, SP_ATTACK, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_SASH
	item_attribute 200, HELD_FOCUS_SASH, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CLEAR_BELL
...
; GANLON_BERRY
	item_attribute 9000, HELD_DEFENSE_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
...
; OLD_AMBER
	item_attribute 1, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AMULET_COIN
...
; LIGHT_CLAY
	item_attribute 10000, HELD_LIGHT_CLAY, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKBELT
	item_attribute 100, HELD_FIGHTING_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIFE_ORB
	item_attribute 2000, HELD_LIFE_ORB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE_BAND
	item_attribute 2000, HELD_CHOICE_BOOST, ATTACK, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 100, HELD_DARK_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MACHO_BRACE
	item_attribute 3000, HELD_MACHO_BRACE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK_BOW
...
; FLAME_ORB
	item_attribute 15000, HELD_FLAME_ORB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TOXIC_ORB
	item_attribute 15000, HELD_TOXIC_ORB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WEATHER_ROCK
	item_attribute 15000, HELD_WEATHER_ROCK, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AIR_BALLOON
	item_attribute 15000, HELD_AIR_BALLOON, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HARD_STONE
...
; MACHINE_PART
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POWER_BAND
	item_attribute 2000, HELD_CATEGORY_BOOST, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE_SCARF
	item_attribute 2000, HELD_CHOICE_BOOST, SPEED, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; STARDUST
...
; METAL_COAT
	item_attribute 2100, HELD_STEEL_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON_FANG
...
; HEAVY_BALL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; PETAYA_BERRY
	item_attribute 9000, HELD_SP_ATTACK_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEVEL_BALL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; LURE_BALL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
...
; SITRUS_BERRY
	item_attribute 10, HELD_SITRUS_BERRY, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; FLAME_DOWN
...
; MAGMARIZER
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAZOR_CLAW
	item_attribute 3000, HELD_CRITICAL_UP, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAZOR_FANG
	item_attribute 3000, HELD_FLINCH, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PROTECTOR
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ODD_KEYSTONE
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; LAPRAS_CALLA
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; SALAC_BERRY
	item_attribute 9000, HELD_SPEED_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; APICOT_BERRY
	item_attribute 9000, HELD_SP_DEFENSE_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PIDGEOT_CALL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; EVIOLITE
	item_attribute 10, HELD_EVIOLITE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POMEG_BERRY
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; KELPSY_BERRY
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; QUALOT_BERRY
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
...
; CANDY_POUCH
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GREPA_BERRY
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; TAMATO_BERRY
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ABILITY_PILL
	item_attribute 10, HELD_NONE, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; TM01
