...
if DEF(_NOPSS)
	move EFFECT_MULTI_HIT,          15, FAIRY,    SPECIAL,   85, 10,   0 ;DOUBLESLAP
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         80, NORMAL,   PHYSICAL, 100, 10,   0 ;RAZOR_WIND
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         45, GRASS,    SPECIAL,  100, 25,   0 ;VINE_WHIP
else
...
if DEF(_NOPSS)
	move EFFECT_FLINCH_HIT,         80, WATER,    SPECIAL,  100, 15,  20 ;WATERFALL
else
	move EFFECT_FLINCH_HIT,         80, WATER,    PHYSICAL, 100, 15,  20 ;WATERFALL
endc
if DEF(_NOPSS)
	move EFFECT_TRAP_TARGET,        35, WATER,    SPECIAL,   85, 15,   0 ;CLAMP
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,        100, WATER,    SPECIAL,   90, 10,   0 ;CRABHAMMER
else
...
endc
if DEF(_NOPSS)
	move EFFECT_SNORE,              50, NORMAL,   PHYSICAL, 100, 15,  30 ;SNORE
else
...
endc
	...
	move EFFECT_TWISTER,            60, DRAGON,   SPECIAL,  100, 20,  20 ;TWISTER
...
if DEF(_NOPSS)
	move EFFECT_FLINCH_HIT,         80, DARK,     PHYSICAL, 100, 15,  20 ;DARK_PULSE
else
	move EFFECT_FLINCH_HIT,         80, DARK,     SPECIAL,  100, 15,  20 ;DARK_PULSE
endc
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         80, DRAGON,   SPECIAL,  100, 15,   0 ;DRAGON_CLAW
else
	move EFFECT_NORMAL_HIT,         80, DRAGON,   PHYSICAL, 100, 15,   0 ;DRAGON_CLAW
endc
if DEF(_NOPSS)
	move EFFECT_ACCURACY_DOWN_HIT,  65, STEEL,    PHYSICAL,  85, 10,  30 ;MIRROR_SHOT
else
...
if DEF(_NOPSS)
	move EFFECT_PRIORITY_HIT,       40, ICE,      SPECIAL,  100, 30,   0 ;ICE_SHARD
else
	move EFFECT_PRIORITY_HIT,       40, ICE,      PHYSICAL, 100, 30,   0 ;ICE_SHARD
endc
if DEF(_NOPSS)
	move EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,    PHYSICAL, 100, 10,  10 ;FLASH_CANNON
else
	move EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,    SPECIAL,  100, 10,  10 ;FLASH_CANNON
endc
if DEF(_NOPSS)
	move EFFECT_DEFENSE_DOWN_HIT,   90, BUG,      PHYSICAL, 100, 10,  10 ;BUG_BUZZ
else
...
if DEF(_NOPSS)
	move EFFECT_ALL_UP_HIT,         60, BUG,      PHYSICAL, 100,  5,  10 ;SILVER_WIND
else
	move EFFECT_ALL_UP_HIT,         60, BUG,      SPECIAL,  100,  5,  10 ;SILVER_WIND
endc
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         70, GHOST,    SPECIAL,  100, 15,   0 ;SHADOW_CLAW
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         80, GRASS,    SPECIAL,  100, 15,   0 ;SEED_BOMB
else
	move EFFECT_NORMAL_HIT,         80, GRASS,    PHYSICAL, 100, 15,   0 ;SEED_BOMB
endc
if DEF(_NOPSS)
	move EFFECT_STOMP,             100, DRAGON,   SPECIAL,   75, 10,  20 ;DRAGON_RUSH
else
...
if DEF(_NOPSS)
	move EFFECT_FLINCH_HIT,         80, PSYCHIC,  SPECIAL,   90, 15,  20 ;ZEN_HEADBUTT
else
...
if DEF(_NOPSS)
	move EFFECT_RECOIL_HIT,         90, ELECTRIC, SPECIAL,  100, 15,   0 ;WILD_CHARGE
else
	move EFFECT_RECOIL_HIT,         90, ELECTRIC, PHYSICAL, 100, 15,   0 ;WILD_CHARGE
endc
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,        120, GRASS,    SPECIAL,   85, 10,   0 ;POWER_WHIP
else
...
endc
if DEF(_NOPSS)
	move EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING, PHYSICAL,  70,  5,  10 ;FOCUS_BLAST
else
...
if DEF(_NOPSS)
	move EFFECT_POISON_HIT,         95, POISON,   PHYSICAL, 100, 10,  10 ;SLUDGE_WAVE
else
	move EFFECT_POISON_HIT,         95, POISON,   SPECIAL,  100, 10,  10 ;SLUDGE_WAVE
endc
if DEF(_NOPSS)
	move EFFECT_DEFENSE_DOWN_HIT,   90, GROUND,   PHYSICAL, 100, 10,  10 ;EARTH_POWER
else
...
if DEF(_NOPSS)
	move EFFECT_CONFUSE_HIT,        75, BUG,      PHYSICAL, 100, 15,  10 ;SIGNAL_BEAM
else
	move EFFECT_CONFUSE_HIT,        75, BUG,      SPECIAL,  100, 15,  10 ;SIGNAL_BEAM
endc
if DEF(_NOPSS)
	move EFFECT_FLINCH_HIT,         85, ICE,      SPECIAL,   90, 10,  30 ;ICICLE_CRASH
else
...
if DEF(_NOPSS)
	move EFFECT_PRIORITY_HIT,       40, WATER,    SPECIAL,  100, 20,   0 ;AQUA_JET
else
	move EFFECT_PRIORITY_HIT,       40, WATER,    PHYSICAL, 100, 20,   0 ;AQUA_JET
endc
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         90, WATER,    SPECIAL,   90, 10,   0 ;AQUA_TAIL
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         80, ROCK,     PHYSICAL, 100, 20,   0 ;POWER_GEM
else
	move EFFECT_NORMAL_HIT,         80, ROCK,     SPECIAL,  100, 20,   0 ;POWER_GEM
endc
if DEF(_NOPSS)
	move EFFECT_ACCURACY_DOWN_HIT,  65, GROUND,   PHYSICAL,  85, 10,  30 ;MUD_BOMB
else
	move EFFECT_ACCURACY_DOWN_HIT,  65, GROUND,   SPECIAL,   85, 10,  30 ;MUD_BOMB
endc
	move EFFECT_HEX,                65, GHOST,    SPECIAL,  100, 10,   0 ;HEX
if DEF(_NOPSS)
	move EFFECT_VENOSHOCK,          65, POISON,   PHYSICAL, 100, 10,   0 ;VENOSHOCK
else
	move EFFECT_VENOSHOCK,          65, POISON,   SPECIAL,  100, 10,   0 ;VENOSHOCK
endc
if DEF(_NOPSS)
	move EFFECT_HURRICANE,         110, FLYING,   PHYSICAL,  70, 10,  30 ;HURRICANE
else
	move EFFECT_HURRICANE,         110, FLYING,   SPECIAL,   70, 10,  30 ;HURRICANE
endc
if DEF(_NOPSS)
	move EFFECT_FIRE_FANG,          65, FIRE,     SPECIAL,   95, 15,  10 ;FIRE_FANG
else
	move EFFECT_FIRE_FANG,          65, FIRE,     PHYSICAL,  95, 15,  10 ;FIRE_FANG
endc
if DEF(_NOPSS)
	move EFFECT_ICE_FANG,           65, ICE,      SPECIAL,	 95, 15,  10 ;ICE_FANG
else
	move EFFECT_ICE_FANG,           65, ICE,      PHYSICAL,	 95, 15,  10 ;ICE_FANG
endc
if DEF(_NOPSS)
	move EFFECT_THUNDER_FANG,       65, ELECTRIC, SPECIAL,   95, 15,  10 ;THUNDER_FANG
else
	move EFFECT_THUNDER_FANG,       65, ELECTRIC, PHYSICAL,  95, 15,  10 ;THUNDER_FANG
endc
if DEF(_NOPSS)
	move EFFECT_DRACO_FANG,         65, DRAGON,   SPECIAL, 	 95, 15,  10 ;DRACO_FANG
else
...
if DEF(_NOPSS)
	move EFFECT_SLEEP_HIT,          75, FAIRY,    SPECIAL,  100, 15,  10 ;PIXIE_PUNCH
else
...
if DEF(_NOPSS)
	move EFFECT_FLARE_BLITZ,       120, FIRE,     SPECIAL,	100, 15,  10 ;FLARE_BLITZ
else
	move EFFECT_FLARE_BLITZ,       120, FIRE,     PHYSICAL,	100, 15,  10 ;FLARE_BLITZ
endc
if DEF(_NOPSS)
	move EFFECT_HYPER_VOICE,        90, NORMAL,   PHYSICAL,	100, 10,   0 ;HYPER_VOICE
else
	move EFFECT_HYPER_VOICE,        90, NORMAL,   SPECIAL,	100, 10,   0 ;HYPER_VOICE
endc
if DEF(_NOPSS)
...
endc
if DEF(_NOPSS)
	move EFFECT_AVALANCHE,          60, ICE,      SPECIAL,  100, 10,   0 ;AVALANCHE
else
...
if DEF(_NOPSS)
	move EFFECT_MULTI_HIT,          25, ICE,      SPECIAL,  100, 30,   0 ;ICICLE_SPEAR
else
...
endc
	...
	move EFFECT_POWERUPPUNCH,       40, FIGHTING, PHYSICAL, 100, 20, 100 ;POWERUPPUNCH
	...
	move EFFECT_POISON_FANG,        50, POISON,   PHYSICAL, 100, 15,  50 ;POISON_FANG
if DEF(_NOPSS)
	move EFFECT_SPEED_UP_HIT,       50, FIRE,     SPECIAL,  100, 20, 100 ;FLAME_CHARGE
else
...
if DEF(_NOPSS)
	move EFFECT_POISON_HIT,        120, POISON,   PHYSICAL,  80,  5,  30 ;BELCH
else
	move EFFECT_POISON_HIT,        120, POISON,   SPECIAL,   80,  5,  30 ;BELCH
endc
if DEF(_NOPSS)
	move EFFECT_DEFENSE_DOWN_HIT,   40, POISON,   PHYSICAL, 100, 20, 100 ;ACID_SPRAY
else
	move EFFECT_SP_DEF_DOWN_2_HIT,  40, POISON,   SPECIAL,  100, 20, 100 ;ACID_SPRAY
endc
if DEF(_NOPSS)
	move EFFECT_PARALYZE_HIT,       20, ELECTRIC, SPECIAL,	100, 20, 100 ;NUZZLE
else
	move EFFECT_PARALYZE_HIT,       20, ELECTRIC, PHYSICAL,	100, 20, 100 ;NUZZLE
endc
if DEF(_NOPSS)
	move EFFECT_VOLT_TACKLE,       120, ELECTRIC, SPECIAL,  100, 15,  10 ;VOLT_TACKLE
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         60, FLYING,   PHYSICAL,	 95, 25,   0 ;AIR_CUTTER
else
...
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         70, PSYCHIC,  SPECIAL,	100, 20,   0 ;PSYCHO_CUT
else
	move EFFECT_NORMAL_HIT,         70, PSYCHIC,  PHYSICAL,	100, 20,   0 ;PSYCHO_CUT
endc
if DEF(_NOPSS)
	move EFFECT_DOUBLE_HIT,         40, DRAGON,   SPECIAL,   90, 15,   0 ;DUAL_CHOP
else
	move EFFECT_DOUBLE_HIT,         40, DRAGON,   PHYSICAL,  90, 15,   0 ;DUAL_CHOP
endc
	move EFFECT_BOUNCE,            100, FLYING,   PHYSICAL,	 85,  5,  30 ;BOUNCE
...
if DEF(_NOPSS)
	move EFFECT_BURN_HIT,           85, FIRE,     SPECIAL,   90, 10,  10 ;BLAZE_KICK
else
	move EFFECT_BURN_HIT,           85, FIRE,     PHYSICAL,  90, 10,  10 ;BLAZE_KICK
endc
if DEF(_NOPSS)
	move EFFECT_CIRCLE_THROW,       60, DRAGON,   SPECIAL,   90, 10,   0 ;DRAGON_TAIL
else
	move EFFECT_CIRCLE_THROW,       60, DRAGON,   PHYSICAL,  90, 10,   0 ;DRAGON_TAIL
endc
	move EFFECT_OHKO,                0, ICE,      SPECIAL,   30,  5,   0 ;SHEER_COLD
if DEF(_NOPSS)
	move EFFECT_NORMAL_HIT,         90, GRASS,    SPECIAL,  100, 15,   0 ;LEAF_BLADE
else
...
if DEF(_NOPSS)
	move EFFECT_FURY_CUTTER,        40, NORMAL,   PHYSICAL, 100, 15,   0 ;ECHOED_VOICE
else
...
if DEF(_NOPSS)
	move EFFECT_PRIORITY_HIT,       40, GHOST,    SPECIAL,  100, 30,   0 ;SHADOW_SNEAK
else
	move EFFECT_PRIORITY_HIT,       40, GHOST,    PHYSICAL, 100, 30,   0 ;SHADOW_SNEAK
endc
if DEF(_NOPSS)
	move EFFECT_STOMP,              60, GRASS,    SPECIAL,  100, 15,  30 ;NEEDLE_ARM
else
...
if DEF(_NOPSS)
	move EFFECT_SPEED_DOWN_HIT,    100, ROCK,     PHYSICAL,  80, 10,  20 ;JURASSICBEAM
else
	move EFFECT_SPEED_DOWN_HIT,    100, ROCK,     SPECIAL,   80, 10,  20 ;JURASSICBEAM
endc
if DEF(_NOPSS)
	move EFFECT_CONFUSE_HIT,       110, BUG,      PHYSICAL,  85,  5,  10 ;SIGNAL_WAVE
else
	move EFFECT_CONFUSE_HIT,       110, BUG,      SPECIAL,   85,  5,  10 ;SIGNAL_WAVE
endc
if DEF(_NOPSS)
	move EFFECT_RECOIL_HIT,        120, WATER,    SPECIAL,  100, 10,   0 ;WAVE_CRASH
else
	move EFFECT_RECOIL_HIT,        120, WATER,    PHYSICAL, 100, 10,   0 ;WAVE_CRASH
endc
	move EFFECT_FAKE_OUT,           40, NORMAL,   PHYSICAL, 100, 10, 100 ;FAKE_OUT
	move EFFECT_CLOSE_COMBAT,      120, GROUND,   PHYSICAL, 100,  5, 100 ;HEADLONGRUSH
	move EFFECT_DOUBLE_HIT,         40, FLYING,   PHYSICAL,  90, 10,   0 ;DUALWINGBEAT
	move EFFECT_DOUBLE_HIT,         40, PSYCHIC,  SPECIAL,  100, 10,   0 ;TWIN_BEAM
	move EFFECT_CONFUSE_HIT,       115, DARK,     SPECIAL,   85,  5,  20 ;CATASTROPHE
if DEF(_NOPSS)
	move EFFECT_DEFENSE_UP_HIT,     70, PSYCHIC,  SPECIAL,   90, 10, 100 ;PSYSHIELD
else
	move EFFECT_DEFENSE_UP_HIT,     70, PSYCHIC,  PHYSICAL,  90, 10, 100 ;PSYSHIELD
endc
	...
	move EFFECT_PSYCHO_BOOST,      140, PSYCHIC,  SPECIAL,   90,  5, 100 ;PSYCHO_BOOST
	move EFFECT_RECOIL_HIT,        150, ROCK,     PHYSICAL,  90,  5,   0 ;HEAD_SMASH
if DEF(_NOPSS)
	move EFFECT_RAMPAGE,           120, FIRE,     SPECIAL,  100, 10,   0 ;RAGING_FURY
else
	move EFFECT_RAMPAGE,           120, FIRE,     PHYSICAL, 100, 10,   0 ;RAGING_FURY
endc
	move EFFECT_CONFUSE_HIT,        90, FAIRY,    SPECIAL,   95, 10,  20 ;STRANGESTEAM
	...
	move EFFECT_FREEZE_HIT,         90, PSYCHIC,  SPECIAL,  100, 10,  10 ;FREEZE_GLARE
	move EFFECT_DEFENSE_DOWN_HIT,   90, FIGHTING, PHYSICAL, 100, 10, 100 ;THUNDER_KICK
	move EFFECT_FLINCH_HIT,         90, DARK,     SPECIAL,  100, 10,  20 ;FIERY_WRATH
if DEF(NO_PSS)
	move EFFECT_POISON_HIT,         90, POISON,   PHYSICAL, 100, 10,  20 ;SHELLSIDEARM
else
	move EFFECT_POISON_HIT,         90, POISON,   SPECIAL,  100, 10,  20 ;SHELLSIDEARM
endc
	move EFFECT_EERIE_SPELL,        80, PSYCHIC,  SPECIAL,  100,  5,   0 ;EERIE_SPELL
	move EFFECT_HYPER_BEAM,        150, FIGHTING, PHYSICAL, 100,  5,   0 ;METEOASSAULT
if DEF(NO_PSS)
	move EFFECT_CLEAR_SMOG,         50, POISON,   PHYSICAL, 100, 15,   0 ;CLEAR_SMOG
else
	move EFFECT_CLEAR_SMOG,         50, POISON,   SPECIAL,  100, 15,   0 ;CLEAR_SMOG
endc
	move EFFECT_RAGING_BULL,        90, NORMAL,   PHYSICAL, 100, 10,   0 ;RAGING_BULL
if DEF(NO_PSS)
	move EFFECT_INFERNABLAST,       60, GHOST,    PHYSICAL, 100, 15,  30 ;INFERNABLAST
else
	move EFFECT_INFERNABLAST,       60, GHOST,    SPECIAL,  100, 15,  30 ;INFERNABLAST
endc
	move EFFECT_DIRE_CLAW,          80, POISON,   PHYSICAL, 100, 15,  50 ;DIRE_CLAW
	move EFFECT_PHANTOM_FORCE,     120, GHOST,    PHYSICAL, 100, 10,   0 ;PHANTOMFORCE
if DEF(NO_PSS)
	move EFFECT_BLOOD_MOON,        140, NORMAL,   PHYSICAL, 100,  5,   0 ;BLOOD_MOON
else
	move EFFECT_BLOOD_MOON,        140, NORMAL,   SPECIAL,  100,  5,   0 ;BLOOD_MOON
endc
	...
	move EFFECT_STONE_AXE,          64, ROCK,     PHYSICAL,  90, 15,   0 ;STONE_AXE
