...
; EcruteakCity
	...
	db SPRITE_POKE_BALL, STILL_SPRITE
	db SPRITE_FRUIT_TREE, STILL_SPRITE
	db SPRITE_OFFICER_STANDING, STANDING_SPRITE
	db SPRITE_GRAMPS_STANDING, STANDING_SPRITE
	db 0 ; end
...
; Route40, Route41, CianwoodCity, BattleTowerOutside
	...
	db SPRITE_STANDING_YOUNGSTER, STANDING_SPRITE ; non-walking version of SPRITE_YOUNGSTER
	db SPRITE_POKE_BALL, STILL_SPRITE
	db 0 ; end
