...
MapGroup_Blackthorn:
	...
	map HoOhLugiaRoom, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketLairHallway1, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairBreakRoom, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairHallway2, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
