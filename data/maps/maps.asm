...
MapGroup_Route47:
	map Route47, TILESET_ROUTE_47, ROUTE, ROUTE_47, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route48, TILESET_ROUTE_47, ROUTE, ROUTE_48, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CliffCave, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map WildAreaOutside, TILESET_ROUTE_47, TOWN, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA_OUTSIDE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
