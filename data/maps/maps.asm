...
MapGroup_Dungeons:
	...
	map RadioTower1F, TILESET_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower2F, TILESET_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower3F, TILESET_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower4F, TILESET_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map TeamRocketBaseB1F, TILESET_UNDERGROUND, GATE, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB2F, TILESET_FACILITY, GATE, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB3F, TILESET_FACILITY, GATE, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map TeamRocketBaseJail, TILESET_UNDERGROUND, GATE, UNKNOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map GlitchCity, TILESET_KANTO, INDOOR, UNKNOWN_2, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_Cerulean:
	...
	map PowerPlant, TILESET_RADIO_TOWER, CAVE, POWER_PLANT, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavRadioTower1F, TILESET_CHAMPIONS_ROOM, INDOOR, LAV_RADIO_TOWER, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map RadioTower5F, TILESET_TOWER, GATE, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map CliffsEdgeGate, TILESET_CAVE, INDOOR, CLIFFS_EDGE_GATE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_POND
...
MapGroup_BellchimePath:
	map BellchimePath, TILESET_JOHTO, ROUTE, BELLCHIME_PATH, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_SeviiIslands:
	...
	map TreasureBeach, TILESET_KANTO_2, ROUTE, TREASURE_BEACH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
