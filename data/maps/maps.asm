...
; pointers to the first map of each map group
	...
	dw MapGroup_Route47
	dw MapGroup_BellchimePath
	dw MapGroup_SeviiIslands
	dw MapGroup_SeviiIslands2
	dw MapGroup_SeviiIslands3
...
MapGroup_Olivine:
	...
	map OlivineGym1F, TILESET_UNDERGROUND, INDOOR, OLIVINE_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineGym2F, TILESET_UNDERGROUND, INDOOR, OLIVINE_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineGym3F, TILESET_UNDERGROUND, INDOOR, OLIVINE_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineGym4F, TILESET_UNDERGROUND, INDOOR, OLIVINE_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map MahoganyGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LAKE_OF_RAGE, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route42, TILESET_JOHTO, ROUTE, ROUTE_42, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_REMORAID
	...
	map FossilHouse, TILESET_FACILITY, INDOOR, ROUTE_42, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_POND
...
MapGroup_Dungeons:
	...
	map RadioTower1F, TILESET_TOWER, INDOOR, GOLDENROD_CITY, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower2F, TILESET_TOWER, INDOOR, GOLDENROD_CITY, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower3F, TILESET_TOWER, INDOOR, GOLDENROD_CITY, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower4F, TILESET_TOWER, INDOOR, GOLDENROD_CITY, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map TeamRocketBaseB1F, TILESET_UNDERGROUND, GATE, MAHOGANY_TOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB2F, TILESET_FACILITY, GATE, MAHOGANY_TOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB3F, TILESET_FACILITY, GATE, MAHOGANY_TOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map UndergroundPath, TILESET_UNDERGROUND, GATE, ROUTE_5, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map DarkCaveNewEntrance, TILESET_DARK_CAVE, CAVE, DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map LighthouseElevator, TILESET_MART, INDOOR, LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BurnedTower2F, TILESET_TOWER, DUNGEON, BURNED_TOWER, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TeamRocketBaseJail, TILESET_UNDERGROUND, GATE, MAHOGANY_TOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map NownRoom, TILESET_RUINS_OF_ALPH, DUNGEON, RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map NownPuzzleRoom, TILESET_RUINS_OF_ALPH, DUNGEON, RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SilverCaveRestRoom, TILESET_CAVE, INDOOR, SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Ecruteak:
	...
	map EcruteakMoveTutorHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_POND
...
MapGroup_Blackthorn:
	...
	map RivalsHouse1F, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MastersHouse1F, TILESET_LAB, INDOOR, BLACKTHORN_CITY, MUSIC_DRAGONS_DEN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MastersHouse2F, TILESET_LAB, INDOOR, BLACKTHORN_CITY, MUSIC_DRAGONS_DEN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalsHouse2F, TILESET_PLAYERS_ROOM, INDOOR, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HoOhLugiaRoom, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketLairHallway1, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairBreakRoom, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairHallway2, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairHallway3, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map RocketLairBossRoom, TILESET_FACILITY, GATE, DARK_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_Cinnabar:
	...
	map CinnabarIsland, TILESET_KANTO, TOWN, CINNABAR_ISLAND, MUSIC_CINNABAR_ISLAND, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map PokemonMansion1F, TILESET_POKEMON_MANSION, INDOOR, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonMansion2F, TILESET_POKEMON_MANSION, INDOOR, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonMansion3F, TILESET_POKEMON_MANSION, INDOOR, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonMansionB1F, TILESET_POKEMON_MANSION, INDOOR, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_LAKE
	map CinnabarVolcano1F, TILESET_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map CinnabarVolcanoB1F, TILESET_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map CinnabarVolcanoB2F, TILESET_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map CinnabarIslandMart, TILESET_MART, INDOOR, CINNABAR_ISLAND, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarIslandGym, TILESET_TRAIN_STATION, INDOOR, CINNABAR_ISLAND, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GlitchCity, TILESET_KANTO, INDOOR, ROUTE_20, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIsland1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB4F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
...
MapGroup_Cerulean:
	...
	map PowerPlant, TILESET_RADIO_TOWER, CAVE, ROUTE_10, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
...
MapGroup_LakeOfRage:
	...
	map LakeOfRagePokecenter1F, TILESET_POKECENTER, INDOOR, LAKE_OF_RAGE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map LakeOfRageMart, TILESET_MART, INDOOR, LAKE_OF_RAGE, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SootheBellHouse, TILESET_HOUSE, INDOOR, LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map InfantGrove, TILESET_JOHTO, ROUTE, INFANT_GROVE, MUSIC_POKEMON_LULLABY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Violet:
	...
	map EarlsPokemonAcademy, TILESET_LAB, INDOOR, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GhostHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map Route36VioletGate, TILESET_GATE, INDOOR, ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_Goldenrod:
	...
	map GoldenrodBikeShop, TILESET_TRADITIONAL_HOUSE, INDOOR, GOLDENROD_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodDeptStoreRoof, TILESET_MART, DUNGEON, GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map GoldenrodJail, TILESET_UNDERGROUND, INDOOR, GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BerryCafe, TILESET_GAME_CORNER, INDOOR, GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavRadioTower1F, TILESET_CHAMPIONS_ROOM, INDOOR, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	map Route28, TILESET_JOHTO, ROUTE, ROUTE_28, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCaveOutside, TILESET_JOHTO, TOWN, SILVER_CAVE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map TinTowerRoof, TILESET_TOWER, ROUTE, TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower5F, TILESET_TOWER, GATE, GOLDENROD_CITY, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map DracoScene, TILESET_DRACO_SCENE, GATE, TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map DahliaScene, TILESET_DAHLIA_SCENE, GATE, TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map HoOhTowerScene, TILESET_TOWER_ROOF, GATE, TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
...
MapGroup_Celadon:
	...
	map CeladonMansionRoof, TILESET_MANSION, DUNGEON, CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CeladonMansionRoofHouse, TILESET_HOUSE, INDOOR, CELADON_CITY, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FedHideout1F, TILESET_FED_HIDEOUT, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
	map FedHideoutB1F, TILESET_FED_HIDEOUT, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
	map FedHideoutB2F, TILESET_FED_HIDEOUT, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
	map FedHideoutB3F, TILESET_FED_HIDEOUT, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
	map FedHideoutB4F, TILESET_FED_HIDEOUT, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
	map FedHideoutElevator, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI_2
...
MapGroup_Cianwood:
	...
	map CliffsEdgeGate, TILESET_CAVE, INDOOR, MAHOGANY_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_POND

MapGroup_Viridian:
	map Route2, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SilphCo1F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveFisherHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_OCEAN

MapGroup_Route47:
	map Route47, TILESET_JOHTO_3, ROUTE, ROUTE_47, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route48, TILESET_JOHTO_3, ROUTE, ROUTE_48, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CliffCave, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map WildAreaOutside, TILESET_JOHTO_3, TOWN, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA_OUTSIDE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildAreaPokecenter, TILESET_POKECENTER, INDOOR, WILD_AREA_OUTSIDE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map WildAreaMart, TILESET_MART, INDOOR, WILD_AREA_OUTSIDE, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WildArea1, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea23, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map WildAreaCave, TILESET_CAVE, CAVE, WILD_AREA_OUTSIDE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map WildArea4, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea5, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CliffCaveB1F, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map EmbeddedTower, TILESET_TOWER, CAVE, EMBEDDED_TOWER, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map WildAreaPond, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map WildAreaIceCave, TILESET_ICE_PATH, CAVE, WILD_AREA_OUTSIDE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map WildArea6, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea7, TILESET_JOHTO_3, ROUTE, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI

MapGroup_BellchimePath:
	map BellchimePath, TILESET_JOHTO, ROUTE, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map MtSilverSummit, TILESET_SUMMIT, ROUTE, SILVER_CAVE, MUSIC_UNWAVERING_HEART, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map GoldCrystalHouse, TILESET_PLAYERS_HOUSE, INDOOR, SILVER_CAVE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SilverCaveMewRoom, TILESET_DARK_CAVE, CAVE, SILVER_CAVE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SilverCaveSummitOutside, TILESET_JOHTO, ROUTE, SILVER_CAVE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI

MapGroup_SeviiIslands:
	map OneIslandPort, TILESET_PORT, INDOOR, ONE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map OneIsland, TILESET_KANTO_2, TOWN, ONE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map TreasureBeach, TILESET_KANTO_2, ROUTE, ONE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map KindleRoad, TILESET_KANTO_2, ROUTE, KINDLE_ROAD, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MtEmberOutside, TILESET_KANTO_2, ROUTE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map RegidragoPuzzleChamber, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RegidragoChamber, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OneIslandPokecenter, TILESET_POKECENTER, INDOOR, ONE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map TwoIslandPort, TILESET_PORT, INDOOR, TWO_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map TwoIsland, TILESET_KANTO_2, TOWN, TWO_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map TwoIslandHouse, TILESET_HOUSE, INDOOR, TWO_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map TwoIslandGameHouse, TILESET_HOUSE, INDOOR, TWO_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map CapeBrink, TILESET_KANTO_2, ROUTE, CAPE_BRINK, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CapeBrinkHouse, TILESET_HOUSE, INDOOR, CAPE_BRINK, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map TwoIslandPokecenter, TILESET_POKECENTER, INDOOR, TWO_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map ThreeIslandPort, TILESET_PORT, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map ThreeIsland, TILESET_KANTO_2, TOWN, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map BondBridge, TILESET_KANTO_2, ROUTE, BOND_BRIDGE, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map BerryForest, TILESET_KANTO_2, FOREST, BERRY_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ThreeIslandPokecenter, TILESET_POKECENTER, INDOOR, THREE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map ThreeIslandMart, TILESET_MART, INDOOR, THREE_ISLAND, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map ThreeIslandHouse1, TILESET_HOUSE, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map ThreeIslandHouse2, TILESET_HOUSE, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map ThreeIslandHouse3, TILESET_HOUSE, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map ThreeIslandHouse4, TILESET_HOUSE, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map ThreeIslandHouse5, TILESET_HOUSE, INDOOR, THREE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FourIslandPort, TILESET_PORT, INDOOR, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FourIsland, TILESET_KANTO_2, TOWN, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map FourIslandMart, TILESET_MART, INDOOR, FOUR_ISLAND, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FourIslandHouse1, TILESET_HOUSE, INDOOR, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FourIslandHouse2, TILESET_HOUSE, INDOOR, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FourIslandHouse3, TILESET_HOUSE, INDOOR, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FourIslandLoreleisHouse, TILESET_HOUSE, INDOOR, FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map IcefallCaveEntrance, TILESET_ICE_PATH, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map IcefallCave1F, TILESET_ICE_PATH, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map IcefallCave2F, TILESET_ICE_PATH, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map IcefallCaveBackCave, TILESET_ICE_PATH, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map RegicePuzzleChamber, TILESET_CAVE, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RegiceChamber, TILESET_ICE_PATH, CAVE, ICEFALL_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map FourIslandPokecenter, TILESET_POKECENTER, INDOOR, FOUR_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map CeliosHouse, TILESET_HOUSE, INDOOR, ONE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map OneIslandHouse, TILESET_HOUSE, INDOOR, ONE_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MtEmberSummit, TILESET_KANTO_2, ROUTE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MtEmberInside1, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside2, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside3, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside4, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside5, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside6, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside7, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside72, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside8, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map MtEmberInside9, TILESET_CAVE, CAVE, MT_EMBER, MUSIC_VICTORY_ROAD_RSE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN

MapGroup_SeviiIslands2:
	map FiveIslandPort, TILESET_PORT, INDOOR, FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FiveIsland, TILESET_KANTO_2, TOWN, FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map FiveIslandHouse1, TILESET_HOUSE, INDOOR, FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map FiveIslandHouse2, TILESET_HOUSE, INDOOR, FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map WaterLabyrinth, TILESET_KANTO_2, ROUTE, WATER_LABYRINTH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ResortGorgeous, TILESET_KANTO_2, ROUTE, RESORT_GORGEOUS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map FiveIsleMeadow, TILESET_KANTO_2, ROUTE, FIVE_ISLE_MEADOW, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MemorialIsland, TILESET_KANTO_2, ROUTE, MEMORIAL_ISLAND, MUSIC_UNWAVERING_HEART, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map FiveIslandPokecenter, TILESET_POKECENTER, INDOOR, FIVE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SelphysHouse, TILESET_HOUSE, INDOOR, RESORT_GORGEOUS, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RocketWarehouse, TILESET_FED_HIDEOUT, INDOOR, FIVE_ISLE_MEADOW, MUSIC_ROCKET_LAIR, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map LostCaveEntrance, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom1, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom2, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom3, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom4, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom5, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom6, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom7, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom8, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRoom9, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RegielekiPuzzleChamber, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LostCaveRegieleki, TILESET_CAVE, CAVE, LOST_CAVE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map SixIslandPort, TILESET_PORT, INDOOR, SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map SixIsland, TILESET_KANTO_2, TOWN, SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WaterPath, TILESET_KANTO_2, ROUTE, WATER_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map GreenPath, TILESET_KANTO_2, ROUTE, GREEN_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map GreenPathHouse1, TILESET_HOUSE, INDOOR, GREEN_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map GreenPathHouse2, TILESET_HOUSE, INDOOR, GREEN_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OutcastIsland, TILESET_KANTO_2, ROUTE, OUTCAST_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map AlteringCave, TILESET_CAVE, CAVE, ALTERING_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RegirockPuzzleChamber, TILESET_CAVE, CAVE, ALTERING_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RegirockChamber, TILESET_CAVE, CAVE, ALTERING_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RuinValley, TILESET_KANTO_2, ROUTE, RUIN_VALLEY, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SixIslandPokecenter, TILESET_POKECENTER, INDOOR, SIX_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SixIslandMart, TILESET_MART, INDOOR, SIX_ISLAND, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SixIslandHouse, TILESET_HOUSE, INDOOR, SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map DottedHoleEntrance, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map DottedHoleB1F, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map DottedHoleB2F, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map DottedHoleB3F, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map DottedHoleB4F, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RegisteelPuzzleChamber, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RegisteelChamber, TILESET_CAVE, CAVE, DOTTED_HOLE, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE

MapGroup_SeviiIslands3:
	map SevenIslandPort, TILESET_PORT, INDOOR, SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map SevenIsland, TILESET_KANTO_2, TOWN, SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SevenIslandMastersHouse, TILESET_LAB, INDOOR, SEVEN_ISLAND, MUSIC_DRAGONS_DEN, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SevenIslandPokecenter, TILESET_POKECENTER, INDOOR, SEVEN_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SevenIslandMart, TILESET_MART, INDOOR, SEVEN_ISLAND, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SevaultCanyon, TILESET_KANTO_2, ROUTE, SEVAULT_CANYON, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SevaultCanyonHouse, TILESET_HOUSE, INDOOR, SEVAULT_CANYON, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map TanobiRuins, TILESET_KANTO_2, ROUTE, TANOBI_RUINS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map OnaganTempleOutside, TILESET_KANTO_2, ROUTE, ONAGAN_TEMPLE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map OnaganTempleInside, TILESET_CAVE, DUNGEON, ONAGAN_TEMPLE, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map RegigigasChamber, TILESET_CAVE, DUNGEON, ONAGAN_TEMPLE, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map MoneanChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map LiptooChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map WeepthChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map DilfordChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map ScufibChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map RixyChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map ViapoisChamber, TILESET_RUINS_OF_ALPH, DUNGEON, TANOBI_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_NONE
