...
MapGroup_Dungeons:
	...
	map RadioTower5F, TILESET_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map TeamRocketBaseB1F, TILESET_UNDERGROUND, DUNGEON, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB2F, TILESET_FACILITY, DUNGEON, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TeamRocketBaseB3F, TILESET_FACILITY, DUNGEON, UNKNOWN, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map TeamRocketBaseJail, TILESET_UNDERGROUND, DUNGEON, UNKNOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
