...
MapGroup_Route47:
	map Route47, TILESET_ROUTE_47, ROUTE, ROUTE_47, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route48, TILESET_ROUTE_47, ROUTE, ROUTE_48, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CliffCave, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map WildAreaOutside, TILESET_ROUTE_47, TOWN, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map WildAreaMart, TILESET_MART, INDOOR, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WildArea1, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea23, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map WildAreaCave, TILESET_CAVE, CAVE, WILD_AREA_OUTSIDE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map WildArea4, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map WildArea5, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
