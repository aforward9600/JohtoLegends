...
MapGroup_SeviiIslands2:
	...
	map SevenIslandPort, TILESET_PORT, INDOOR, SEVEN_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map SevenIsland, TILESET_KANTO_2, TOWN, SEVEN_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
