...
MapGroup_Route47:
	...
	map WildArea1, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea23, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map WildAreaCave, TILESET_CAVE, CAVE, WILD_AREA_OUTSIDE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map WildArea4, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map WildArea5, TILESET_ROUTE_47, INDOOR, WILD_AREA_OUTSIDE, MUSIC_WILD_AREA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
