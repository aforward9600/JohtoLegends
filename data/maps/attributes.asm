...
ENDM
	...
	map_attributes GoldenrodPokecenter1F, GOLDENROD_POKECENTER_1F, $00, 00, 0
	...
	map_attributes FourIslandHouse1, FOUR_ISLAND_HOUSE_1, $00, 0
	...
	map_attributes SevaultCanyonHouse, SEVAULT_CANYON, $00, 0
