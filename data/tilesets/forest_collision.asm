	...
	tilecoll WALL, HEADBUTT_TREE, FLOOR, HEADBUTT_TREE ; 2a
	tilecoll FLOOR, FLOOR, WALL, WALL ; 2b
	tilecoll WALL, WALL, FLOOR, FLOOR ; 2c
	tilecoll TALL_GRASS, HEADBUTT_TREE, TALL_GRASS, HEADBUTT_TREE ; 2d
	tilecoll HEADBUTT_TREE, TALL_GRASS, HEADBUTT_TREE, TALL_GRASS ; 2e
	...
	tilecoll WARP_CARPET_UP, HEADBUTT_TREE, FLOOR, HEADBUTT_TREE ; 34
	tilecoll HEADBUTT_TREE, WARP_CARPET_UP, HEADBUTT_TREE, FLOOR ; 35
