...
BattleTowerMons1:
	...
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 200, 224, 195, 200, 200, 200 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 14, 13, 15, 11 ; DVs
	db 10, 10, 10, 10 ; PP
	db 100 ; Happiness
	...
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 174, 174, 174, 183, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 15, 13, 15, 14 ; DVs
	db 20, 10, 20, 5 ; PP
	db 100 ; Happiness
...
BattleTowerMons4:
	...
	dw PORYGON2
	db NO_ITEM
	dw NASTY_PLOT, CONVERSION, PSYBEAM, THIEF
...
BattleTowerMons7:
	...
	dw 0 ; OT ID
	dt 343000 ; Exp
	db 232, 245, 235, 224, 241, 241 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 13, 13, 13, 13 ; DVs
	db 20, 5, 10, 10 ; PP
	db 100 ; Happiness
	...
	dw 0 ; OT ID
	dt 343000 ; Exp
	db 213, 235, 200, 235, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 13, 13, 14, 13 ; DVs
	db 10, 5, 10, 5 ; PP
	db 100 ; Happiness
...
BattleTowerMons8:
	...
	dw 0 ; OT ID
	dt 512000 ; Exp
	db 245, 235, 224, 235, 245, 245 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 13, 11, 14, 13 ; DVs
	db 10, 10, 15, 10 ; PP
	db 100 ; Happiness
...
BattleTowerMons10:
	...
	dw 0 ; OT ID
	dt 1000000 ; Exp
	db 224, 224, 224, 188, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 15, 13, 15, 14 ; DVs
	db 15, 20, 20, 15 ; PP
	db 100 ; Happiness
	...
	dw 0 ; OT ID
	dt 1000000 ; Exp
	db 224, 200, 224, 188, 188, 188 ; EVs
	db 0, 0, 0, 0 ; padding
	dn 13, 13, 15, 14 ; DVs
	db 15, 5, 5, 10 ; PP
	db 100 ; Happiness
