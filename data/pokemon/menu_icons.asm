...
MonMenuIcons:
	...
	db ICON_RATTATA_A   ; RATTATA_A
	db ICON_RATICATE    ; RATICATE
	db ICON_RATICATE_A  ; RATICATE_A
	...
	db ICON_RAICHU_A    ; RAICHU
	db ICON_SANDSHREW   ; SANDSHREW
	db ICON_SANDSHREW_A ; SANDSHREW_A
	db ICON_SANDSLASH   ; SANDSLASH
	db ICON_SANDSLASH_A ; SANDSLASH_A
	...
	db ICON_VULPIX_A    ; VULPIX_A
	db ICON_NINETALES   ; NINETALES
	db ICON_NINETALES_A ; NINETALES_A
	...
	db ICON_DIGLETT_A   ; DIGLETT_A
	db ICON_DUGTRIO     ; DUGTRIO
	db ICON_DUGTRIO_A   ; DUGTRIO_A
