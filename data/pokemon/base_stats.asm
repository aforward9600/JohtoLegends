...
BaseData::
	...
	if ((__RGBDS_MAJOR__ << 24) | (__RGBDS_MINOR__ << 8) | __RGBDS_PATCH__) >= $400
		...
		assert $23 == BASE_DATA_SIZE, "Please adjust the table size (and this assertion) to match BASE_DATA_SIZE"
	endc
	indirect_table $23, 1
	indirect_entries SENTRET, BaseData1
...
INCLUDE "data/pokemon/base_stats/diglett_a.asm"
INCLUDE "data/pokemon/base_stats/dugtrio.asm"
INCLUDE "data/pokemon/base_stats/dugtrio_a.asm"
