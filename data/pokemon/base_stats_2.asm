...
INCLUDE "data/pokemon/base_stats/ursaluna_blood.asm"
...
INCLUDE "data/pokemon/base_stats/corsola_j.asm"
...
INCLUDE "data/pokemon/base_stats/tauros_p_fire.asm"
INCLUDE "data/pokemon/base_stats/tauros_p_water.asm"
