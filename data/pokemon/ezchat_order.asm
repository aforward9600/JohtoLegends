...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, ELEKID, ELECTABUZZ, TOGEKISS, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, MAMOSWINE, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, MISMAGIUS, -1
...
.ho_bo_po: db SKARMINI, HOOTHOOT, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
