...
.sa_za:    db RHYHORN, GLISCOR, CORSOLA, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH, -1 ; RHYDON should lead this list
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, MAMOSWINE, PARAS, PARASECT, QWILFISH, MR__MIME, TANGROWTH, CLOYSTER, MISMAGIUS, -1
