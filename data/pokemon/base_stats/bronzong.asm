	...
	; tm/hm learnset
	tmhm CURSE, HEX, TOXIC, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, BULLDOZE, SOLARBEAM, EARTHQUAKE, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SANDSTORM, ROCK_TOMB, SUBSTITUTE, FLASH_CANNON, ROCK_SLIDE, REST, THIEF, CALM_MIND, DREAM_EATER, SLEEP_TALK, DARK_PULSE, GIGA_IMPACT, STEEL_SLICE, GYRO_BALL, HYPNOSIS, GRASS_KNOT
	; end
