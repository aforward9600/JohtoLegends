...
SeafoamIslandB4F_MapEvents:
	...
	db 6 ; warp events
	warp_event 11,  9, SEAFOAM_ISLAND_B3F, 4
	warp_event 25,  5, SEAFOAM_ISLAND_B3F, 5
	warp_event 20, 19, SEAFOAM_ISLAND_B3F, 8
	warp_event 21, 19, SEAFOAM_ISLAND_B3F, 9
	warp_event  4, 17, SEAFOAM_ISLAND_B3F, 10
	warp_event  5, 17, SEAFOAM_ISLAND_B3F, 11
	...
	db 4 ; object events
	object_event  7,  3, SPRITE_ARTICUNO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ArticunoScript, EVENT_SEAFOAM_ISLAND_ARTICUNO
	object_event  7,  8, SPRITE_BIRD_KEEPER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeafoamIslandBirdkeeperScript, -1
	object_event  4, 18, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeafoamIslandB4FBoulder, EVENT_SEAFOAM_ISLAND_BOULDER_B4F_1
	object_event  5, 18, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeafoamIslandB4FBoulder, EVENT_SEAFOAM_ISLAND_BOULDER_B4F_2
