...
KindleRoadRegidragoText:
	text "There is said to"
	line "be two Legendary"
	cont "#mon at Mt."
	cont "Ember…"

	para "One at the summit,"
	line "and one in the"
	cont "depths."

	para "Nobody has seen"
	line "them out of fear."
	done
...
KindleRoad_MapEvents:
	...
	object_event 17, 40, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, KindleRoadCarbos, EVENT_KINDLE_ROAD_CARBOS
	object_event 18, 65, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, KindleRoadMaxRepel, EVENT_KINDLE_ROAD_MAX_REPEL
	object_event 19, 67, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, KindleRoadFullRestore, EVENT_KINDLE_ROAD_FULL_RESTORE
