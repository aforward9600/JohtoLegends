...
CeruleanGymBadgeSpeechHouse_MapEvents:
	...
	db 2 ; object events
	object_event  3,  3, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MistysGrandmotherScript, -1
	object_event  7,  6, SPRITE_MISTY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BabyMistyScript, -1
