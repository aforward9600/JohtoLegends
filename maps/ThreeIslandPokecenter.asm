	...
	const THREEISLANDPOKECENTER_NURSE
;	const WILDAREAPOKECENTER_GENTLEMAN
;	const WILDAREAPOKECENTER_FISHING_GURU

ThreeIslandPokecenter_MapScripts:
	db 0 ; scene scripts

	db 0 ; callbacks

ThreeIslandPokecenterNurseScript:
	jumpstd pokecenternurse

ThreeIslandPokecenter_MapEvents:
	db 0, 0 ; filler

	db 3 ; warp events
	warp_event  3,  7, THREE_ISLAND, 3
	warp_event  4,  7, THREE_ISLAND, 3
	...
	db 1 ; object events
	object_event  3,  1, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ThreeIslandPokecenterNurseScript, -1
