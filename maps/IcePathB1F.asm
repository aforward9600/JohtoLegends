...
.Script:
	endifjustbattled
	jumptext YoungsterTimmyAfterText
...
.Script:
	endifjustbattled
	jumptext BoarderGarethAfterText
...
.Script:
	endifjustbattled
	jumptext BoarderBrodyAfterText
...
IcePathB1F_MapEvents:
	...
	object_event  3, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL,0, IcePathB1FNevermeltice, EVENT_ICE_PATH_B1F_RAZOR_CLAW
