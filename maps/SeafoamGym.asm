...
.ReturnAfterBattle:
	...
	opentext
	writetext ReceivedVolcanoBadgeText2
	playsound SFX_GET_BADGE
	waitsfx
	setflag ENGINE_VOLCANOBADGE
	writetext BlaineAfterBattleText2
	waitbutton
	closetext
	end

.FightDone:
	writetext BlaineFightDoneText2
	waitbutton
	closetext
	end
...
ReceivedVolcanoBadgeText2:
	text "<PLAYER> received"
	line "VOLCANOBADGE."
	done

BlaineAfterBattleText2:
...
SeafoamGym_MapEvents:
	...
	object_event  6,  5, SPRITE_GYM_GUY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SeafoamGymGuyScript, -1
