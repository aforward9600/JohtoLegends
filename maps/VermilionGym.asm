...
VermilionGym_MapEvents:
	...
	object_event  3, 15, SPRITE_SOLDIER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerSoldierUlysses, -1
	object_event  8, 11, SPRITE_SOLDIER, SPRITEMOVEDATA_STANDING_DOWN, 3, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSoldierDouglas, -1
	object_event  4,  7, SPRITE_SOLDIER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSoldierGrant, -1
