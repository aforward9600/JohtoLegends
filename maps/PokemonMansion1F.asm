...
.TurnOffSwitch:
	...
	changeblock  2,  4, $2b ; Closed Eyes
	reloadmappart
	end
...
PokemonMansion1F_MapEvents:
	...
	db 5 ; object events
	object_event  6,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, PokemonMansion1FDiary, -1
	object_event 25,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, PokemonMansion1FDiary2, -1
