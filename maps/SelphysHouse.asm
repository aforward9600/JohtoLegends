...
SelphysHouse_MapEvents:
	...
	db 2 ; warp events
	warp_event  2,  7, RESORT_GORGEOUS, 1
	warp_event  3,  7, RESORT_GORGEOUS, 1
	...
	db 2 ; object events
	object_event  2,  4, SPRITE_TWIN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SelphysHouseSelphyScript, -1
	object_event  5,  5, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SelphysHouseButlerScript, -1
