...
WildArea23_MapEvents:
	...
	db 2 ; bg events
	bg_event 19, 16, BGEVENT_READ, WildArea2Sign
	bg_event 5, 6, BGEVENT_READ, WildArea3Sign
	...
	object_event  9,  6, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WildArea23FisherScript, -1
