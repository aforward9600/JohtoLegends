...
VermilionFishingSpeechHouse_MapEvents:
	...
	db 1 ; bg events
	bg_event  8,  0, BGEVENT_READ, FishingDudesHousePhoto

	db 1 ; object events
	object_event  3,  4, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, FishingDude, -1
