...
IcePathB2FBlackthornSide_MapEvents:
	...
	object_event  3,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IcePathB2FBlackthornSideRareCandy, EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_RARE_CANDY
