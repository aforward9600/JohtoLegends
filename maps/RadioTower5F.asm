...
.RivalAppears1:
	...
	moveobject RADIOTOWER5F_RIVAL, 7, 17
...
RadioTower5F_MapEvents:
	...
	db 2 ; coord events
	coord_event  6, 15, SCENE_DEFAULT, RadioTowerMiyamotoScene1
	coord_event  7, 15, SCENE_DEFAULT, RadioTowerMiyamotoScene2

	db 0 ; bg events

	db 2 ; object events
	object_event  7, 12, SPRITE_MIYAMOTO, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_GOLDENROD_TOWER_TAKEOVER
