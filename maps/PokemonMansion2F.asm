...
PokemonMansion2F_MapEvents:
	...
	db 6 ; object events
	object_event  4, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, PokemonMansion2FDiary, -1
	object_event 19,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, PokemonMansion2FDiary2, -1
