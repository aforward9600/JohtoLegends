...
OlivineLighthouse2F_MapEvents:
	...
	object_event  9, 14, SPRITE_SWINUB, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LighthouseSwinubScript, EVENT_LIGHTHOUSE_ROCKETS
	object_event 10, 14, SPRITE_RATICATE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LighthouseRaticateScript, EVENT_LIGHTHOUSE_ROCKETS
