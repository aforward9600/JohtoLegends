...
.Script:
	endifjustbattled
	opentext
	writetextend BikerDwayneAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend BikerHarrisAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend BikerZekeAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend SupernerdSamAfterBattleText
