...
.Script:
	endifjustbattled
	opentext
	writetextend BikerCharlesAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend BikerRileyAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend BikerJoelAfterBattleText
...
.Script:
	endifjustbattled
	opentext
	writetextend RoughneckCurlyAfterBattleText
