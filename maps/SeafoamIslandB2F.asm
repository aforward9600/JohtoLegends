...
SeafoamIslandB2F_MapEvents:
	...
	warp_event 16,  7, SEAFOAM_ISLAND_B1F, 9
	warp_event 24,  8, SEAFOAM_ISLAND_B1F, 10
	warp_event 19,  6, SEAFOAM_ISLAND_B3F, 6
	warp_event 22,  6, SEAFOAM_ISLAND_B3F, 7
	warp_event 25, 11, SEAFOAM_ISLAND_B1F, 11
	...
	db 2 ; object events
	object_event 17,  5, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeafoamIslandB2FBoulder, EVENT_SEAFOAM_ISLAND_BOULDER_B2F_1
	object_event 25,  7, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeafoamIslandB2FBoulder, EVENT_SEAFOAM_ISLAND_BOULDER_B2F_2
