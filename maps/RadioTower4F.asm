...
TrainerArcher2:
	trainer ARCHER, ARCHER_2, EVENT_BEAT_ROCKET_EXECUTIVEM_2, Executivem2SeenText, Executivem2BeatenText, 0, .Script
...
RadioTower4F_MapEvents:
	...
	object_event 14,  1, SPRITE_ARCHER, SPRITEMOVEDATA_STANDING_LEFT, 2, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerArcher2, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
