...
.TurnOffSwitchB1F:
	...
	changeblock 18, 24, $2b ; Close Eyes
	changeblock 20,  2, $2b ; Close Eyes
	reloadmappart
	end
...
PokemonMansionB1F_MapEvents:
	...
	db 7 ; object events
	object_event 17, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, PokemonMansionB1FDiary, -1
