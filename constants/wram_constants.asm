...
GBPRINTER_LIGHTEST EQU $00 ; Ability Yes
GBPRINTER_LIGHTER  EQU $20 ; Ability No
...
; wDailyFlags2:: ; dc1f
	...
	const DAILYFLAGS3_BEAT_MILTON_F
	const DAILYFLAGS3_BEAT_KURT_F
	const DAILYFLAGS3_BEAT_WALKER_F
	const DAILYFLAGS3_BEAT_MASTER_F

; wSwarmFlags:: ; dc20
	const_def
	const SWARMFLAGS_BUENAS_PASSWORD_F           ; 0
	const SWARMFLAGS_GOLDENROD_DEPT_STORE_SALE_F ; 1
	const SWARMFLAGS_DAILY_TELEVISION_F          ; 2
	const SWARMFLAGS_DUNSPARCE_SWARM_F           ; 3
	const SWARMFLAGS_ALT_SWARM_F                 ; 4
	const SWARMFLAGS_MOBILE_4_F                  ; 5
