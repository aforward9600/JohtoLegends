...
; ???
	...
	const EVENT_PASSWORD_MONOCHROME
	const EVENT_GOT_MACHO_BRACE
	const EVENT_GOT_SHINY_BELDUM
	const EVENT_GOT_SHINY_DITTO
	const EVENT_ECRUTEAK_CITY_POLITOED
	const EVENT_BEAT_POLITOED
	const EVENT_CAUGHT_POLITOED
	const EVENT_FIVE_ISLAND_FERROPEXOLA
	const EVENT_GOT_THICK_CLUB_FROM_FERROPEXOLA
	const EVENT_BEAT_REGIROCK
	const EVENT_BEAT_REGICE
	const EVENT_BEAT_REGISTEEL
	const EVENT_BEAT_REGIELEKI
	const EVENT_BEAT_REGIDRAGO
	const EVENT_BEAT_REGIGIGAS
	const EVENT_CAUGHT_REGIROCK
	const EVENT_CAUGHT_REGICE
	const EVENT_CAUGHT_REGISTEEL
	const EVENT_CAUGHT_REGIELEKI
	const EVENT_CAUGHT_REGIDRAGO
	const EVENT_CAUGHT_REGIGIGAS
	const EVENT_LOST_BOY_TWO_ISLAND
	const EVENT_LOST_BOY_BERRY_FOREST
	const EVENT_ALTERING_CAVE_REGIROCK
	const EVENT_ICEFALL_CAVE_REGICE
	const EVENT_DOTTED_HOLE_REGISTEEL
	const EVENT_MT_EMBER_REGIDRAGO
	const EVENT_LOST_CAVE_REGIELEKI
	const EVENT_ONAGAN_TEMPLE_REGIGIGAS
	const EVENT_WALL_OPENED_IN_REGIDRAGO_CHAMBER
	const EVENT_WALL_OPENED_IN_REGIROCK_CHAMBER
	const EVENT_PASSWORD_SHINY
	const EVENT_PASSWORD_NO_MONOCHROME
	const EVENT_PASSWORD_SET_3
	const EVENT_MT_EMBER_ERRUPTED
	const EVENT_SPOKE_TO_SEVEN_ISLAND_MASTER
	const EVENT_GOT_LIECHI_BERRY_ON_TWO_ISLAND
	const EVENT_WALL_OPENED_IN_REGICE_CHAMBER
	const EVENT_KINDLE_ROAD_MAX_REPEL
	const EVENT_KINDLE_ROAD_FULL_RESTORE
	const EVENT_KINDLE_ROAD_CARBOS
	const EVENT_BEAT_YOUNGSTER_MIK
	const EVENT_BEAT_CAMPER_GERALD
	const EVENT_BEAT_HYPNO
	const EVENT_CAUGHT_HYPNO
	const EVENT_BERRY_FOREST_HYPNO
	const EVENT_BERRY_FOREST_ORAN_BERRY
	const EVENT_BERRY_FOREST_LUM_BERRY
	const EVENT_BERRY_FOREST_RAWST_BERRY
	const EVENT_BERRY_FOREST_CHERI_BERRY
	const EVENT_BERRY_FOREST_CHESTO_BERRY
	const EVENT_BERRY_FOREST_PERSIM_BERRY
	const EVENT_BERRY_FOREST_PECHA_BERRY
	const EVENT_BERRY_FOREST_ASPEAR_BERRY
	const EVENT_BEAT_ROCKET_WAREHOUSE_GRUNTM
	const EVENT_BEAT_ROCKET_WAREHOUSE_GRUNTF
	const EVENT_BEAT_ROCKET_WAREHOUSE_ARIANA
	const EVENT_BEAT_ROCKET_WAREHOUSE_ARCHER
	const EVENT_ICEFALL_CAVE_2F_NEVERMELTICE
	const EVENT_ICEFALL_CAVE_2F_FULL_RESTORE
	const EVENT_ICEFALL_CAVE_1F_ULTRA_BALL
	const EVENT_ICEFALL_CAVE_1F_ICE_STONE
	const EVENT_FIVE_ISLE_MEADOW_PP_UP
	const EVENT_WALL_OPENED_IN_REGISTEEL_CHAMBER
	const EVENT_WALL_OPENED_IN_REGIELEKI_CHAMBER
	const EVENT_WALL_OPENED_IN_REGIGIGAS_CHAMBER
	const EVENT_GOT_SHINY_MUNCHLAX_EGG
	const EVENT_RESORT_GORGEOUS_STARDUST
	const EVENT_BEAT_YOUNGSTER_JORGE
	const EVENT_WATER_PATH_DRAGON_SCALE
	const EVENT_BEAT_COOLTRAINERM_RICHIE
	const EVENT_GREEN_PATH_ELIXER
	const EVENT_BEAT_COOLTRAINER_F_CORINA
	const EVENT_BEAT_LASS_YVONNE
	const EVENT_OUTCAST_ISLAND_PP_UP
	const EVENT_RUIN_VALLEY_SUN_STONE
	const EVENT_RUIN_VALLEY_HP_UP
	const EVENT_SEVAULT_CANYON_KINGS_ROCK
	const EVENT_SEVAULT_CANYON_ETHER
	const EVENT_BEAT_LASS_SAMANTHA
	const EVENT_BEAT_COOLTRAINERM_HECTOR
	const EVENT_BEAT_COOLTRAINERF_PHOEBE
	const EVENT_ROUTE_35_SCOPE_LENS
	const EVENT_MT_EMBER_MOLTRES_G
	const EVENT_BEAT_MOLTRES_G
	const EVENT_CAUGHT_MOLTRES_G
	const EVENT_MT_SILVER_ARTICUNO_G
	const EVENT_BEAT_ARTICUNO_G
	const EVENT_CAUGHT_ARTICUNO_G
	const EVENT_SEVAULT_CANYON_ZAPDOS_1
	const EVENT_BEAT_ZAPDOS_G
	const EVENT_CAUGHT_ZAPDOS_G
	const EVENT_MT_EMBER_DRAGON_FANG
	const EVENT_SEVAULT_CANYON_ZAPDOS_2
	const EVENT_SEVAULT_CANYON_ZAPDOS_3
	const EVENT_SEVAULT_CANYON_ZAPDOS_4
	const EVENT_GOT_ODD_KEYSTONE
	const EVENT_OLIVINE_GYM_FIRST_PLATFORM
	const EVENT_OLIVINE_GYM_SECOND_PLATFORM
	const EVENT_OLIVINE_GYM_THIRD_PLATFORM
	const EVENT_OLIVINE_GYM_FOURTH_PLATFORM
	const EVENT_OLIVINE_GYM_FIFTH_PLATFORM
	const EVENT_OLIVINE_GYM_SIXTH_PLATFORM
	const EVENT_OLIVINE_GYM_SEVENTH_PLATFORM
	const EVENT_OLIVINE_GYM_EIGHTH_PLATFORM
	const EVENT_OLIVINE_GYM_NINTH_PLATFORM
	const EVENT_OLIVINE_GYM_TENTH_PLATFORM
	const EVENT_GOLDENROD_DEPT_STORE_POKEFAN_M
	const EVENT_RESET_MAX_DVS_PASSWORD
	const EVENT_MET_RIVAL_AT_GOLDENROD_GYM
	const EVENT_BEAT_CLAIR_REMATCH
	const EVENT_BEAT_LANCE_REMATCH
	const EVENT_FAST_NURSE
	const EVENT_1EA
	const EVENT_1EB
	const EVENT_1EC
	const EVENT_1ED
...
; Phone events
	...
	const EVENT_RESET_SHINY_PASSWORD
...
; Lass
	...
	const EVENT_BEAT_LASS_GABRIELLE
