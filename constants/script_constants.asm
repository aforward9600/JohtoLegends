...
; UnownWalls and MenuHeaders_UnownWalls indexes (see data/events/unown_walls.asm)
	...
	const UNOWNWORDS_LEFT
	const UNOWNWORDS_RIGHT
	const UNOWNWORDS_UP
	const UNOWNWORDS_DOWN
	const UNOWNWORDS_REGIDRAGO
	const UNOWNWORDS_REGIROCK
	const UNOWNWORDS_REGICE
	const UNOWNWORDS_REGISTEEL
	const UNOWNWORDS_REGIELEKI
	const UNOWNWORDS_REGIGIGAS
...
; MoveTutor setval arguments
	...
	const MOVETUTOR_DRACO_FANG   ; 4
	const MOVETUTOR_FIRE_PUNCH   ; 5
	const MOVETUTOR_THUNDERPUNCH ; 6
	const MOVETUTOR_ICE_PUNCH    ; 7
	const MOVETUTOR_PIXIE_PUNCH  ; 8
