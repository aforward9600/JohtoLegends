...
; wUnlockedUnowns
	...
	const ENGINE_LAPRAS_CALLB
	const ENGINE_LAPRAS_CALLC ; 30
	const ENGINE_ABILITIES_OFF
	const ENGINE_SHINY_PASSWORD
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_ROUTE_26
	...
	const ENGINE_FLYPOINT_WILD_AREA
...
; wDailyFlags2
	...
	const ENGINE_BEAT_ENOKI
	const ENGINE_BEAT_CHIGUSA
	const ENGINE_BEAT_BYRON
	const ENGINE_BEAT_MILTON
	const ENGINE_BEAT_KURT
	const ENGINE_BEAT_WALKER
	const ENGINE_BEAT_MASTER
; wSwarmFlags
...
; wSwarmFlags
	const ENGINE_DAILY_TELEVISION ; a0
	const ENGINE_GHOST_HOUSE_DUSKNOIR
	const ENGINE_ALT_SWARM
	const ENGINE_ILEX_FOREST_FARFETCHD
