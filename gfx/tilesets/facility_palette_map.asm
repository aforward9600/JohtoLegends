	...
	tilepal 0, GRAY, GRAY, GRAY, GRAY, ROOF, ROOF, ROOF, WATER
	tilepal 0, GRAY, GRAY, GRAY, WATER, WATER, ROOF, GRAY, GRAY
	tilepal 0, PRIORITY_GRAY, PRIORITY_GRAY, PRIORITY_GRAY, PRIORITY_GRAY, ROOF, ROOF, ROOF, TEXT
	tilepal 1, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 1, GRAY, GRAY, GRAY, PRIORITY_GRAY, RED, RED, BROWN, BROWN
