	tilepal 0, GRAY, GRAY, ROOF, GRAY, RED, BROWN, WATER, WATER
	tilepal 0, GREEN, GREEN, GREEN, GREEN, WATER, WATER, BROWN, BROWN
	tilepal 0, GRAY, ROOF, ROOF, ROOF, RED, BROWN, WATER, WATER
	tilepal 0, ROOF, ROOF, ROOF, ROOF, GRAY, GRAY, BROWN, BROWN
	tilepal 0, GRAY, ROOF, ROOF, ROOF, WATER, BROWN, BROWN, BROWN
	...
	tilepal 1, WATER, GRAY, RED, YELLOW, GRAY, YELLOW, WATER, WATER
	tilepal 1, GREEN, GREEN, GREEN, GREEN, WATER, WATER, BROWN, BROWN
	tilepal 1, YELLOW, GRAY, GRAY, GRAY, RED, YELLOW, WATER, WATER
	tilepal 1, BROWN, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN
	tilepal 1, GRAY, GRAY, GRAY, GRAY, WATER, ROOF, ROOF, BROWN
	tilepal 1, BROWN, BROWN, YELLOW, GREEN, WATER, WATER, WATER, BROWN
	tilepal 1, BROWN, BROWN, GRAY, GRAY, WATER, GRAY, BROWN, BROWN
