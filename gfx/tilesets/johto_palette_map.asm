	...
	tilepal 0, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, ROOF, ROOF
	tilepal 0, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, ROOF
	tilepal 0, ROOF, BROWN, BROWN, RED, BROWN, BROWN, ROOF, TEXT
	...
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, WATER, WATER, WATER, WATER, WATER, BROWN, BROWN, ROOF
