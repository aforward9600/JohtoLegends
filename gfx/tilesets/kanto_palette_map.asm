	...
	tilepal 1, ROOF, RED, RED, RED, RED, GRAY, GRAY, GRAY
	tilepal 1, GRAY, GRAY, GRAY, GRAY, BROWN, ROOF, GRAY, GRAY
	tilepal 1, GREEN, GREEN, GREEN, GRAY, GREEN, GREEN, GREEN, GRAY
	tilepal 1, BROWN, BROWN, BROWN, WATER, BROWN, BROWN, BROWN, BROWN
	tilepal 1, BROWN, BROWN, BROWN, BROWN, GRAY, GREEN, GREEN, GRAY
	tilepal 1, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN
	tilepal 1, BROWN, BROWN, BROWN, BROWN, GRAY, GREEN, GREEN, RED
