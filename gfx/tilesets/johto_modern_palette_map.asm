	...
	tilepal 1, YELLOW, TEXT, BROWN, BROWN, TEXT, BROWN, BROWN, TEXT
	tilepal 1, BROWN, BROWN, BROWN, BROWN, ROOF, BROWN, BROWN, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, TEXT, BROWN, BROWN, BROWN
	tilepal 1, BROWN, BROWN, BROWN, TEXT, TEXT, TEXT, BROWN