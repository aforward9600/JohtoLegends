	...
	tilepal 0, ROOF, ROOF, ROOF, GREEN, WATER, WATER, BROWN, BROWN
	...
	tilepal 0, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, GREEN, BROWN, GREEN, GREEN, GREEN
	tilepal 0, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, ROOF
	tilepal 0, ROOF, BROWN, BROWN, ROOF, BROWN, GREEN, GREEN, TEXT
	tilepal 1, GRAY, GRAY, GREEN, GREEN, RED, RED, RED, RED
